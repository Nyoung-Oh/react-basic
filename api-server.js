...
app.use('/openapi/getdata', function (req, res) { //이벤트 발생 시 자동 실행되는 함수인 콜백 함수가 실행된다.
    ...
    var queryParams = '?' + encodeURIComponent('serviceKey') + '=06xEMgBuOy8M2oq9CNDXjtOHy3A02q%2BYyEebwb4VpfyYRn3cGdxJAfE7zGz%2FN3UyYbdiQ5XDeYzFOwYbnQyncw%3D%3D'; /* Service Key*/

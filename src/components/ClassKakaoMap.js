...
class KakaoMap extends Component {
    constructor(props) {
        ...
        this.onSearch = this.onSearch.bind(this); //검색
        this.onChange = this.onChange.bind(this); //페이징처리
        this.removeAllChildNods = this.removeAllChildNods.bind(this); //기존 마커 지우기
